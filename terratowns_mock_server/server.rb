...
# Adding validation for the towns 
...
class TerraTownsMockServer < Sinatra::Base
  ...
  def x_access_code
    return '161c81a7-6e56-4bf8-a7ee-a9eb1ad638dd'
  end

  def x_user_uuid
    return 'b6d73de7-ec12-4e1a-be74-1bf255c27b8d'
  end
  ...
  post '/api/u/:user_uuid/homes' do
    ...
    begin
      # Sinatra does not automatically parse JSON body's as params
    ...
    # Create a new Home model and set it to attributes
    home = Home.new
    home.town = town
    home.name = name
